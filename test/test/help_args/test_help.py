...
def get_help_stdout(dockerc_path: str):
    return (
        ...
        b'    @rb    run --rm --build\n'
        b'    @ri    run --rm -it\n'
        b'    @rbi   run --rm --build -it\n'
        b'    @sh    run --rm -it --entrypoint /bin/sh\n'
        b'    @$     run --rm -it --entrypoint /bin/sh\n'
        b'    $      run --rm -it --entrypoint /bin/sh\n'
        b'    @shb   run --rm --build -it --entrypoint /bin/sh\n'
        b'    @bash  run --rm -it --entrypoint /bin/bash\n'
        b'    @bashb run --rm --build -it --entrypoint /bin/bash\n'
        b'    @l     logs\n'
        b'    @rf    rm -f\n'
        b'    @rfv   rm -f -v\n'
